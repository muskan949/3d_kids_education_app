...
class CaseOnePage extends StatefulWidget {

  const CaseOnePage({Key? key}) : super(key: key);

  @override
  State<CaseOnePage> createState() => _CaseOnePageState();
}

class _CaseOnePageState extends State<CaseOnePage> {
  int score=0;
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text("(1) Which animal is this?",style: mcqteststyle(),),
                        Container(
                  ...
                  Container(
                   // color: Colors.green,
                    ...
                    child: Column(
                      children: [
                        Text("(2) Which animal is this?",style: mcqteststyle(),),
                        Container(
                          padding: EdgeInsets.only(left: width*0.18),
                          child: Column(
                            children: [
                  ...
                  Container(
                   // color: Colors.green,
                    ...
                    child: Column(
                      children: [
                        Text("(3) Which animal is this?",style: mcqteststyle(),),
                        Container(
                          padding: EdgeInsets.only(left: width*0.18),
                          child: Column(
                            children: [
                  ...
                  Container(
                   // color: Colors.green,
                    ...
                    child: Column(
                      children: [
                        Text("(4) Which insect is this?",style: mcqteststyle(),),
                        Container(
                          padding: EdgeInsets.only(left: width*0.18),
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text("Bee",style: mcqteststyletwo(),),
                              ...
                              Row(
                                children: [
                                  ...
                                  Text("Fly",style: mcqteststyletwo(),),
                                ],
                              ),
                  ...
                  //  color: Colors.green,
                    ...
                    child: Column(
                      children: [
                        Text("(5) Which animal is this?",style: mcqteststyle(),),
                        Container(
                          padding: EdgeInsets.only(left: width*0.18),
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text("Camel",style: mcqteststyletwo(),),
                                ],
                              ),
